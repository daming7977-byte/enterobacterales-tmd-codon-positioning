...
infile = Path(
    "work/final_results/leave_one_orthogroup_out_start.tsv"
)

out_pdf = Path(
    "manuscript/SUPPLEMENTARY_FIGURE_S3_leave_one_orthogroup_out.pdf"
)

out_png = Path(
    "manuscript/SUPPLEMENTARY_FIGURE_S3_leave_one_orthogroup_out.png"
)
