...
out_file = Path(
    "work/codon/exact_species_final_soluble_cds_protein_qc.tsv"
)
...
# Load final 197 matched soluble members.
targets = []
...
# Load CDS sequences from all assemblies.
cds_sequences = {}

cds_files = list(
    Path("data").rglob("cds_from_genomic.fna")
)
        ...
        for line in f:
            ...
            if line.startswith(">"):
                ...
                if m:
                    ...
                    # Reconstructed FASTA, e.g. Salmonella
...
print()
print("Usable:", usable)
print("Unusable:", len(targets) - usable)
