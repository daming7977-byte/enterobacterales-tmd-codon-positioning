...
null_file = Path(
    "work/final_results/without_tmd1_null_medians_1000.tsv"
)

out_pdf = Path(
    "manuscript/SUPPLEMENTARY_FIGURE_S1_without_TMD1.pdf"
)

out_png = Path(
    "manuscript/SUPPLEMENTARY_FIGURE_S1_without_TMD1.png"
)
