...
positions_out = Path(
    "work/codon/final_soluble_codon_position_adaptation.tsv"
)
...
# ------------------------------------------------------------
# Load final soluble target proteins
# ------------------------------------------------------------
...
with positions_out.open("w") as out:
    ...
    out.write(
        ...
        "codon_position\tcodon\tamino_acid\t"
        "relative_weight\tlow_adaptation\n"
    )
...
print("Observed soluble low fractions:")
