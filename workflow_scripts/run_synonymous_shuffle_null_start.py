...
observed_table = Path("work/codon/modal_tmd_start_cross_species_conservation.tsv")

out_summary = Path("work/codon/synonymous_shuffle_null_start_summary_1000perm.tsv")
out_unit = Path("work/codon/synonymous_shuffle_null_start_units_1000perm.tsv")
    ...
    for full_id, info in protein_codons.items():
        ...
        for segment_start, segment_end in segments:
            ...
            for row in protein_tmds:
                ...
                distance_center = segment_center - tmd_start
