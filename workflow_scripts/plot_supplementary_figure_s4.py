...
start_file = Path("work/codon/soluble_pseudo_anchor_start.tsv")
end_file = Path("work/codon/soluble_pseudo_anchor_end.tsv")

out_pdf = Path(
    "manuscript/SUPPLEMENTARY_FIGURE_S4_soluble_pseudo_anchor_QC.pdf"
)

out_png = Path(
    "manuscript/SUPPLEMENTARY_FIGURE_S4_soluble_pseudo_anchor_QC.png"
)
