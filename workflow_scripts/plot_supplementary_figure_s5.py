...
infile = Path("work/final_results/membrane_vs_soluble_family_paired.tsv")
out_pdf = Path("manuscript/SUPPLEMENTARY_FIGURE_S5_family_level_differences.pdf")
out_png = Path("manuscript/SUPPLEMENTARY_FIGURE_S5_family_level_differences.png")
