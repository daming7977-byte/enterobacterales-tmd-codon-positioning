...
null_file = Path(
    "results/fixed_presence_position_null_summary_1000.tsv"
)

out_pdf = Path(
    "figures/SUPPLEMENTARY_FIGURE_S2_fixed_presence_null.pdf"
)

out_png = Path(
    "figures/SUPPLEMENTARY_FIGURE_S2_fixed_presence_null.png"
)
