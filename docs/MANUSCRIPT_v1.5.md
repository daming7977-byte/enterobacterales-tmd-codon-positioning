...
Representative families illustrated that this positional conservation was not confined to a single topological context. In the FocA-family orthogroup_540, low-adaptation segments occurred approximately 27 residues upstream of the first TMD in six of nine species, with a TMD-start-relative variance of only 0.075 aa². In the YghB/DedA-family orthogroup_36, low-adaptation segments overlapped the second TMD in five of eight species, whereas in the ClcA-family orthogroup_105 they clustered within the eighth TMD in five of nine species. These examples indicate that conserved low-adaptation segments can occur both upstream of and within TMDs and are not restricted to a particular TMD position within the protein (Figure 2).

To determine whether the observed positional conservation could arise from synonymous codon composition alone, I performed 1,000 within-protein synonymous-codon permutations. The observed median variance relative to TMD starts was 22.70 aa², compared with a null median-of-medians of 154.33 aa². None of the 1,000 permutations produced a value as low as the observed statistic, corresponding to an empirical one-sided P value of 9.99 × 10⁻⁴. A similar pattern was observed for TMD ends, for which the observed median variance was 34.55 aa² compared with a null median of 147.00 aa² (empirical one-sided P = 9.99 × 10⁻⁴; Figure 3A,B).
...
**Alt text:** Workflow diagram showing selection of 10 Enterobacterales genomes, construction of strict one-to-one orthologous groups, membrane-topology filtering, identification of low-adaptation codon segments, mapping to homologous TMD boundaries, and statistical testing of cross-species positional conservation.
...
**Alt text:** Three representative membrane-protein orthogroups showing low-adaptation codon segments aligned relative to homologous TMD starts across species: FocA with segments upstream of TMD1, YghB/DedA with segments overlapping TMD2, and ClcA with segments near TMD8.
...
**Alt text:** Four panels compare observed TMD-relative positional variance with permutation null distributions. Observed variance is markedly lower than null expectations for TMD starts, TMD ends, analysis excluding first TMDs, and homologous non-TMD pseudo-anchor controls.
...
**Alt text:** Paired plots compare median positional variance in matched membrane and soluble protein families. Soluble families generally show higher variance for TMD-start-matched positions, while the difference is weaker and less consistent for TMD-end-matched positions.
